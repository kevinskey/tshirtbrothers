...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-white overflow-x-hidden">
      ...
      <Link
        to="/shop"
        className="block bg-gray-900 text-white text-center text-[10px] sm:text-xs py-2.5 sm:py-0.5 px-2 sm:px-4 whitespace-nowrap overflow-hidden hover:bg-gray-800 transition-colors"
      >
