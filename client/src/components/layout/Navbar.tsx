...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-white overflow-x-hidden">
      ...
      <Link
        to="/shop"
        className="block bg-gray-900 text-white text-center text-[10px] sm:text-xs py-0.5 px-2 sm:px-4 whitespace-nowrap overflow-hidden hover:bg-gray-800 transition-colors"
      >
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pb-4 border-b border-gray-200/80">
          <div className="relative">
            ...
            <input
              ...
              className="w-full rounded-full bg-gray-100 pl-12 pr-4 py-4 text-base text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:bg-white border border-transparent focus:border-orange-300"
              style={{ fontSize: '16px' }}
            />
          </div>
        </div>
