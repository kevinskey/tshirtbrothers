    ...
    <section className="py-12 md:py-16 bg-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10">
          <p className="text-sm font-semibold text-orange-700 uppercase tracking-wider mb-2">Simple as 1-2-3</p>
        ...
        <div className="text-center mt-10">
          <Link
            to="/design"
            className="inline-flex items-center justify-center bg-orange-700 hover:bg-orange-800 text-white font-semibold px-8 py-3 rounded-lg transition-colors shadow-lg shadow-orange-700/20"
          >
