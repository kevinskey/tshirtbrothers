...
import gangsheetStoreRouter from './routes/gangsheetStore.js';
import embroideryRouter from './routes/embroidery.js';
import mockupsRouter from './routes/mockups.js';
import storesRouter from './routes/stores.js';
import storeShopRouter from './routes/storeShop.js';
import adminStorePayoutsRouter from './routes/adminStorePayouts.js';
import groupStoreAdminRouter from './routes/groupStoreAdmin.js';
import adminGroupStoresRouter from './routes/adminGroupStores.js';
import gleeworldProvisioningRouter from './routes/gleeworldProvisioning.js';
...
app.use('/api/admin/store-payouts', adminStorePayoutsRouter);
app.use('/api/group-store-admin', groupStoreAdminRouter);
app.use('/api/admin/group-stores', adminGroupStoresRouter);
app.use('/api/gleeworld', gleeworldProvisioningRouter);
